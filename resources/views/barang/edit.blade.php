...
<head>
    ...
    <title>Edit Barang - Sistem Informasi Manajemen Laboratorium</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .topbar { position: fixed; top: 0; left: 0; right: 0; height: var(--topbar-height); background: var(--navy); color: white; display: flex; align-items: center; justify-content: space-between; padding: 0 24px 0 16px; z-index: 100; box-shadow: 0 2px 8px rgba(0,0,0,0.2); }
        ...
        .sidebar { position: fixed; top: var(--topbar-height); left: 0; bottom: 0; width: var(--sidebar-width); background: white; border-right: 1px solid #dde3ec; overflow-y: auto; z-index: 90; transition: transform 0.25s ease; padding: 12px 0 24px; }
        ...
        .form-group input, .form-group select, .form-group textarea { padding: 9px 12px; border: 1px solid #d1d5db; border-radius: 8px; font-size: 13.5px; outline: none; font-family: inherit; transition: border-color 0.15s; }
...
<main class="main" id="main">
    <div class="breadcrumb">
        ...
        <span>Edit: {{ $barang->nama }}</span>
    </div>

    <div class="form-card">
        <div class="form-card-title">Edit Barang</div>
        ...
        <form method="POST" action="/barang/{{ $barang->id }}">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="kode" value="{{ old('kode', $barang->kode) }}" placeholder="Contoh: BRG-001">
                    @error('kode') <span class="error-msg">{{ $message }}</span> @enderror
                </div>
                <div class="form-group">
                    <label>Nama Barang <span style="color:#dc2626">*</span></label>
                    <input type="text" name="nama" value="{{ old('nama', $barang->nama) }}" placeholder="Nama lengkap barang">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="kategori" value="{{ old('kategori', $barang->kategori) }}" placeholder="Contoh: Elektronik">
                </div>
                <div class="form-group">
                    <label>Satuan</label>
                    <input type="text" name="satuan" value="{{ old('satuan', $barang->satuan) }}" placeholder="Contoh: Pcs, Kg">
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="stok_min" value="{{ old('stok_min', $barang->stok_min) }}" min="0">
            ...
            <div class="form-row full">
                <div class="form-group">
                    ...
                    <textarea name="keterangan" placeholder="Deskripsi atau keterangan barang">{{ old('keterangan', $barang->keterangan) }}</textarea>
                </div>
            </div>
